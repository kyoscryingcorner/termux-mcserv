...
echo -e "${RED}[${GREEN}#${RED}] Downloading jar file ..."
...
mkdir server1.12.2
cd server1.12.2
        wget -O server1.12.2.jar https://papermc.io/api/v2/projects/paper/versions/1.12.2/builds/1620/downloads/paper-1.12.2-1620.jar
